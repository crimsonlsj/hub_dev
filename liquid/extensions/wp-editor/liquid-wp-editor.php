...
function shortcode_highlight_script()
	...
	public function liquid_styles_dropdown( $settings ) {
		...
		$new_styles = array(
			array(
				'title'    => esc_html__( 'Add Dropcap', 'hub' ),
				'selector' => 'p',
				'classes' => 'add-dropcap',
				'wrapper' => true,
			),
			array(
				'title'	 => esc_html__( 'Highlight', 'hub' ),
				'selector' => '',
				'wrapper' => true,
			),
			array(
				'title'	=> esc_html__( 'Text Transform', 'hub' ),
				'items'	=> array(
					array(
						'title'		=> esc_html__( 'Uppercase', 'hub' ),
						'inline'	=> 'span',
						'styles'    => array( 'text-transform' => 'uppercase' ),
					),
					array(
						'title'		=> esc_html__( 'Lowercase', 'hub' ),
						'inline'	=> 'span',
						'styles'    => array( 'text-transform' => 'lowercase' ),
					),
					array(
						'title'		=> esc_html__( 'Capitalize', 'hub' ),
						'inline'	=> 'span',
			...
			array(
	            'title'    => esc_html__( 'Reset List', 'hub' ),
	            'selector' => 'ul',
	            'classes'  => 'reset-ul',
				'wrapper' => true,
	        ),
			array(
	            'title'    => esc_html__( 'Inline List', 'hub' ),
	            'selector' => 'ul',
