...
var Merlin = (function($){
    ...
    function window_loaded(){
        ...
        function el_button(){
            ...
            $("#default_plugins_liquid_js_composer, #default_plugins_liquid-gdpr").attr('disabled', true);
            $("#default_plugins_liquid_js_composer, #default_plugins_liquid-gdpr").parent().css( "display", "none" );
        }
        ...
        function vc_button(){
            ...
            $("#default_plugins_liquid_js_composer, #default_plugins_liquid-gdpr").attr('disabled', false);
            $("#default_plugins_liquid_js_composer, #default_plugins_liquid-gdpr").parent().css( "display", "list-item" );
        }
